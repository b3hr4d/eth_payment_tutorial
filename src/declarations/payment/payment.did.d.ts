...
export type RejectionCode =
  ...
  | { SysFatal: null }
  | { CanisterReject: null }
export type Result = { Ok: bigint } | { Err: ICRC2ApproveError }
export type Result_1 = { Ok: bigint } | { Err: ICRC1TransferError }
export type Result_2 = { Ok: VerifiedTransactionDetails } | { Err: string }
export type Result_3 = { Ok: RetrieveEthRequest } | { Err: WithdrawalError }
